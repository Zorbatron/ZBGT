    ...
    private static RecipeBuilder<ComponentALRecipeBuilder> getComponentALHighRecipe(int tier, int type) {
        ...
        return switch (type) {
            case (2) -> builder
                    ...
                    .fluidInputs(tier < 8 ? null :
                            getFluidMaterialByTier(tier).getFluid((int) (48 * L * 4 * Math.pow(2, tier - 9))));
            ...
            case (3) -> builder
                    ...
                    .fluidInputs(getSolderingAlloyByTier(tier).getFluid((int) (48 * L * Math.pow(2, tier - 6))))
                    .fluidInputs(Lubricant.getFluid((int) (48 * 250 * Math.pow(2, tier - 6))))
                    .fluidInputs(getFluidPipeMaterialByTier(tier)
                            .getFluid(tier < 9 ? (int) (L * 288 * Math.pow(2, tier - 7)) : L * 4608))
                    .fluidInputs(getMainComponentMaterialByTier(tier).getFluid(47616))
                    .fluidInputs(tier < 8 ? null :
                            getFluidMaterialByTier(tier).getFluid((int) (48 * L * 4 * Math.pow(2, tier - 9))))
                    .fluidInputs(
                            SiliconeRubber.getFluid(tier < 8 ? (int) (L * 48 * Math.pow(2, tier - 6)) : L * 48 * 4));
            ...
            case (4) -> builder
                    ...
                    .fluidInputs(tier < 8 ? null :
                            getFluidMaterialByTier(tier).getFluid((int) (48 * L * 8 * Math.pow(2, tier - 9))));
            ...
            case (5) -> builder
                    ...
                    .fluidInputs(Lubricant.getFluid((int) (48 * 250 * Math.pow(2, tier - 6))))
                    .fluidInputs(
                            tier < 9 ? StyreneButadieneRubber.getFluid((int) (L * 8 * 48 * Math.pow(2, tier - 6))) :
                                    getPolymerByTier(tier).getFluid((int) (L * 8 * 48 * Math.pow(2, tier - 6))))
            ...
            case (6) -> builder
                    ...
                    .input(circuit, getMarkerMaterialByTier(tier), 96)
                    .inputs(getStarByTier(tier)
                            .getStackForm(tier % 2 != 0 ? 96 * (tier > 9 ? 2 : 1) : 48 * (tier > 9 ? 2 : 1)))
                    .fluidInputs(getSolderingAlloyByTier(tier).getFluid((int) (L * 96 * Math.pow(2, tier - 6))))
                    .fluidInputs(tier < 8 ? null :
                            getFluidMaterialByTier(tier).getFluid((int) (48 * L * 8 * Math.pow(2, tier - 9))))
                    .fluidInputs(tier == 7 ? Osmiridium.getFluid(L * 96) :
                            getMainComponentMaterialByTier(tier).getFluid(L * 96))
                    .fluidInputs(
                            tier == 13 ? Bohrium.getFluid(1536 * L) : getSensorEmitterFoil(tier).getFluid(1536 * L));
            ...
            case (8) -> builder
                    .outputs(getFieldGeneratorByTier(tier).getStackForm(64))
                    .inputs(getStarByTier(tier)
                            .getStackForm(tier % 2 != 0 ? 96 * (tier > 8 ? 2 : 1) : 48 * (tier >= 8 ? 2 : 1)))
                    .input(frameGt, getMainComponentMaterialByTier(tier), 48)
                    ...
                    .fluidInputs(getSolderingAlloyByTier(tier)
                            .getFluid(tier == 7 ? L * 192 * 2 : (int) (L * 192 * 3 * Math.pow(2, tier - 8))))
