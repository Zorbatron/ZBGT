    ...
    public static void init() {
        ...
        if (Mods.AppliedEnergistics2.isModLoaded()) {
            BUDGET_CRIB = registerMetaTileEntity(18009,
                    new MetaTileEntityBudgetCRIB(zbgtId("budget_crib"), GTValues.EV));
            BUDGET_CRIB_PROXY = registerMetaTileEntity(18010,
                    new MetaTileEntityBudgetCRIBProxy(zbgtId("budget_crib_proxy"), GTValues.LuV));
        }
    }
}
